...
const TradeOrderModal = ({ transaction, isOpen, onClose }) => {
        ...
        <div>
          ...
          <div className="flex justify-between items-center mt-4">          
           ...
           <div>
              ...
              <span className="text-pay bg-primary-600 px-3 rounded-md py-1 items-center justify-center flex" onClick={() => navigator.clipboard.writeText(transaction.transaction_no)}>
            <FaRegCopy />
            </span>
              </div>
          ...
          <div className="mt-4">
              <span className="text-gray-500 text-sm">Card E-Code</span>
              <h1
              className={`text-sm ${
                transaction.card_code ? "" : "text-gray-400 italic"
              }`}
            >
              {transaction.card_code || "No e-code available"}
            </h1>
            </div>
          ...
          <div className="flex justify-between mt-4">
            ...
            <div>
              ...
              <h1 className="text-sm">₦{Number(transaction.trade_amount).toLocaleString("en-US")}</h1>
            </div>
          </div>
          <div>
          ...
          <div className="flex flex-col mt-4">
            ...
            <p
              className={`text-sm ${
                transaction.comment ? "text-gray-700" : "text-gray-400 italic"
              }`}
            >
